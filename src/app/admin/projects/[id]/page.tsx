    ...
    const fetchProject = async () => {
      try {
        ...
        setFormData({
          ...
          hero_image: {
            url: project.heroImage?.url || project.hero_image?.url || '',
            alt: project.heroImage?.alt || project.hero_image?.alt || '',
            width: project.heroImage?.width || project.hero_image?.width || 0,
            height: project.heroImage?.height || project.hero_image?.height || 0,
          },
          gallery: (project.gallery || []).map((img: Record<string, unknown>) => ({
            url: img.url || '',
            alt: img.alt || '',
            width: img.width || 0,
            height: img.height || 0,
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="font-josefin text-[#D4B896]">Loading project...</p>
        </div>
      </div>
    )
  }
