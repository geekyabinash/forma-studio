...
export const homeContent = pgTable('home_content', {
  ...
  featuredWorkEyebrow: text('featured_work_eyebrow'),
  featuredWorkDescription: text('featured_work_description'),
  featuredWorkProjectSlugs: jsonb('featured_work_project_slugs').$type<string[]>().default([]),
  featuredWorkLimit: integer('featured_work_limit').default(0),
  featuredWorkCtaText: text('featured_work_cta_text'),
  featuredWorkCtaLink: text('featured_work_cta_link'),
  servicesLabel: text('services_label'),
  servicesEyebrow: text('services_eyebrow'),
  servicesDescription: text('services_description'),
  servicesServiceSlugs: jsonb('services_service_slugs').$type<string[]>().default([]),
  servicesLimit: integer('services_limit').default(0),
  servicesCtaText: text('services_cta_text'),
  servicesCtaLink: text('services_cta_link'),
